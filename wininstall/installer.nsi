...
!define MUI_ICON "..\resources\edhud.ico"
...
;  File "..\output\${PRODUCT_NAME}\bearer\*.dll"
  ...
  File "..\output\${PRODUCT_NAME}\iconengines\qsvgicon.dll"
  SetOutPath "$INSTDIR\imageformats"
  File "..\output\${PRODUCT_NAME}\imageformats\*"
  SetOutPath "$INSTDIR"
  File "..\output\${PRODUCT_NAME}\*.dll"
  SetOutPath "$INSTDIR\platforms"
  File "..\output\${PRODUCT_NAME}\platforms\qwindows.dll"
  SetOutPath "$INSTDIR"
  SetOutPath "$INSTDIR\translations"
  File "..\output\${PRODUCT_NAME}\translations\*"
SectionEnd

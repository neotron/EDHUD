...
win-package: 
	...
	rm -f wininstall/*.exe
	env VCINSTALLDIR="c:/User Programs/Visual Studio Community 2015/VC" /cygdrive/c/User\ Programs/Qt/${QT}/msvc2015_64/bin/windeployqt.exe output/EDHUD/EDHUD.exe
